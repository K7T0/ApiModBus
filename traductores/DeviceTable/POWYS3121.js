...
const basica=0;
const armonico_f1=78;
const armonico_f2=142;
const armonico_f3=206;
const maximos=270;
const minimos=348;
const alarmas=426;
const demanda=428;
const contadores=460;
const energia=470;
module.exports={basica, armonico_f1, armonico_f2, armonico_f3, maximos, minimos, alarmas, demanda, contadores, energia};

const get_basica= (data)=>{ //address 0, quantity 78
    var res=[];
...
const get_F1_A= (data)=>{//address 78, quantity 64
    var res=[];
...
const get_F2_A= (data)=>{ //address= 142, quantity 64
    var res=[];
...
const get_F3_A= (data)=>{ //address= 206, quantity 64
    var res=[];
...
const get_Max= (data)=>{ //address= 270, quantity 78
    var res=[];
    //Fase 1
...
const get_Min= (data)=>{ //address= 348, quantity 78
    var res=[];
    //Fase 1
...
const get_alarmas=(data)=>{ //address 426, quantity 2
    var res = [];
    var alarm_flag= reg.tradModbusRegister(data[0], data[1],'int32');
    res.push(alarm_flag);
    return res;
}
const get_demanda=(data)=>{ //address 428, quantity 32
    var res = [];
...
const get_contadores=(data)=>{ //address 460, quantity 10
    var res = [];
    //entrada digital
    var cont_in_dig_1= reg.tradModbusRegister(data[0], data[1],'int32');
    var cont_in_dig_2= reg.tradModbusRegister(data[2], data[3],'int32');
    var cont_hora_recorrida= reg.tradModbusRegister(data[4], data[5],'int32');
    var cont_hora=reg.tradModbusRegister(data[6], data[7],'int32');
    var cont_interrupcion_potencia= reg.tradModbusRegister(data[8], data[9],'int32');
    res.push(cont_in_dig_1, cont_in_dig_2, cont_hora_recorrida, cont_hora, cont_interrupcion_potencia);
    return res;
}
const get_energia=(data)=>{ //address 470, quantity 64
    //Mediciones de energia
    //Energia total tarifa 1 (fase 1+2+3)
    var energia_activa_importada_T1 = reg.tradModbusRegister(data[0], data[1],'int32');
    var energia_activa_exportada_T1 = reg.tradModbusRegister(data[2], data[3],'int32');
    var energia_reactiva_importada_T1 = reg.tradModbusRegister(data[4], data[5],'int32');
    var energia_reactiva_exportada_T1 = reg.tradModbusRegister(data[6], data[7],'int32');
    res.push(energia_activa_importada_T1, energia_activa_exportada_T1, energia_reactiva_importada_T1, energia_reactiva_exportada_T1);
    //Energia total tarifa 2 (fase 1+2+3)
    var energia_activa_importada_T2 = reg.tradModbusRegister(data[8], data[9],'int32');
    var energia_activa_exportada_T2 = reg.tradModbusRegister(data[10], data[11],'int32');
    var energia_reactiva_importada_T2 = reg.tradModbusRegister(data[12], data[13],'int32');
    var energia_reactiva_exportada_T2 = reg.tradModbusRegister(data[14], data[15],'int32');
    res.push(energia_activa_importada_T2, energia_activa_exportada_T2, energia_reactiva_importada_T2, energia_reactiva_exportada_T2);
    //Energia fase 1 tarifa 1
    var energia_activa_importada_F1_T1 = reg.tradModbusRegister(data[16], data[17],'int32');
    var energia_activa_exportada_F1_T1 = reg.tradModbusRegister(data[18], data[19],'int32');
    var energia_reactiva_importada_F1_T1 = reg.tradModbusRegister(data[20], data[21],'int32');
    var energia_reactiva_exportada_F1_T1 = reg.tradModbusRegister(data[22], data[23],'int32');
    res.push(energia_activa_importada_F1_T1, energia_activa_exportada_F1_T1, energia_reactiva_importada_F1_T1, energia_reactiva_exportada_F1_T1);
    //Energia fase 2 tarifa 1
    var energia_activa_importada_F2_T1 = reg.tradModbusRegister(data[24], data[25],'int32');
    var energia_activa_exportada_F2_T1 = reg.tradModbusRegister(data[26], data[27],'int32');
    var energia_reactiva_importada_F2_T1 = reg.tradModbusRegister(data[28], data[29],'int32');
    var energia_reactiva_exportada_F2_T1 = reg.tradModbusRegister(data[30], data[31],'int32');
    res.push(energia_activa_importada_F2_T1, energia_activa_exportada_F2_T1, energia_reactiva_importada_F2_T1, energia_reactiva_exportada_F2_T1);
    //Energia fase 3 tarifa 1
    var energia_activa_importada_F3_T1 = reg.tradModbusRegister(data[32], data[33],'int32');
    var energia_activa_exportada_F3_T1 = reg.tradModbusRegister(data[34], data[35],'int32');
    var energia_reactiva_importada_F3_T1 = reg.tradModbusRegister(data[36], data[37],'int32');
    var energia_reactiva_exportada_F3_T1 = reg.tradModbusRegister(data[38], data[39],'int32');
    res.push(energia_activa_importada_F3_T1, energia_activa_exportada_F3_T1, energia_reactiva_importada_F3_T1, energia_reactiva_exportada_F3_T1);
    //Energia fase 1 tarifa 2
    var energia_activa_importada_F1_T2 = reg.tradModbusRegister(data[40], data[41],'int32');
    var energia_activa_exportada_F1_T2 = reg.tradModbusRegister(data[42], data[43],'int32');
    var energia_reactiva_importada_F1_T2 = reg.tradModbusRegister(data[44], data[45],'int32');
    var energia_reactiva_exportada_F1_T2 = reg.tradModbusRegister(data[46], data[47],'int32');
    res.push(energia_activa_importada_F1_T2, energia_activa_exportada_F1_T2, energia_reactiva_importada_F1_T2, energia_reactiva_exportada_F1_T2);
    //Energia fase 2 tarifa 2
    var energia_activa_importada_F2_T2 = reg.tradModbusRegister(data[48], data[49],'int32');
    var energia_activa_exportada_F2_T2 = reg.tradModbusRegister(data[50], data[51],'int32');
    var energia_reactiva_importada_F2_T2 = reg.tradModbusRegister(data[52], data[53],'int32');
    var energia_reactiva_exportada_F2_T2 = reg.tradModbusRegister(data[54], data[55],'int32');
    res.push(energia_activa_importada_F2_T2, energia_activa_exportada_F2_T2, energia_reactiva_importada_F2_T2, energia_reactiva_exportada_F2_T2);
    //Energia fase 3 tarifa 2
    var energia_activa_importada_F3_T2 = reg.tradModbusRegister(data[56], data[57],'int32');
    var energia_activa_exportada_F3_T2 = reg.tradModbusRegister(data[58], data[59],'int32');
    var energia_reactiva_importada_F3_T2 = reg.tradModbusRegister(data[60], data[61],'int32');
    var energia_reactiva_exportada_F3_T2 = reg.tradModbusRegister(data[62], data[63],'int32');
    res.push(energia_activa_importada_F3_T2, energia_activa_exportada_F3_T2, energia_reactiva_importada_F3_T2, energia_reactiva_exportada_F3_T2);

    return res;
}
module.exports={get_basica, get_Min, get_Max, get_F1_A, get_F2_A, get_F3_A, get_alarmas, get_demanda, get_contadores, get_energia};